...
export function AdminMaterialCategoriesScreen({ navigation }: any) {
    ...
    <View style={styles.categoryCard}>
      <View style={styles.categoryInfo}>
        ...
        <View>
          ...
          <Text style={styles.categoryCount}>{item._count?.materials || 0} matériaux</Text>
        </View>
      </View>
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Catégories de matériaux</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  categoryCount: { fontSize: 12, color: colors.text.muted, marginTop: 2 },
